      ...
      <div className="max-w-xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  type="number" 
                  placeholder="0"
                  className="w-full pl-12 p-4 border-2 border-gray-100 rounded-2xl bg-gray-50 text-3xl font-bold text-gray-800 focus:bg-white focus:border-blue-500 focus:ring-0 transition-all outline-none placeholder:text-gray-300"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-12 p-4 border border-gray-200 rounded-2xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all outline-none font-medium"
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              {filteredCategories.length === 0 && (
                <div className="col-span-full text-center py-8 text-gray-400 text-sm border-2 border-dashed border-gray-200 rounded-2xl bg-white">
                  Belum ada kategori. Silakan buat dulu.
                </div>
              )}
            </div>
          </div>
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full bg-blue-600 hover:bg-blue-700 text-white py-4 rounded-2xl font-bold shadow-xl shadow-blue-200 flex items-center justify-center gap-2 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
